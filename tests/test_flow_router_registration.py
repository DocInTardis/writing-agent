...
def test_generation_and_export_routes_registered_once_from_flow_modules() -> None:
    ...
    expected = {
        ...
        "/healthz": "writing_agent.web.api.system_flow",
        "/api/system/status": "writing_agent.web.api.system_flow",
        ...
        "/api/doc/{doc_id}/citations/resolve-url": "writing_agent.web.api.citation_flow",
        ...
        "/api/metrics/citation_resolve_url": "writing_agent.web.api.citation_flow",
        "/api/metrics/citation_resolve_url/alerts/config": "writing_agent.web.api.citation_flow",
        ...
        "/api/workspaces": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/activity": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/summary": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/batch": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/templates": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/create": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/duplicate": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/archive": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/trash": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/untrash": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/purge": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/restore": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/pin": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/unpin": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/status": "writing_agent.web.api.workspace_flow",
        "/api/workspaces/{doc_id}/update": "writing_agent.web.api.workspace_flow",
        "/api/workspace-views": "writing_agent.web.api.workspace_view_flow",
        "/api/workspace-views/create": "writing_agent.web.api.workspace_view_flow",
        "/api/workspace-views/{view_id}/delete": "writing_agent.web.api.workspace_view_flow",
    }
