...
export class WasmEditor {
    ...
    getStats(): any;
    hitTest(width: number, x: number, y: number, page_gap: number): any;
...
export interface InitOutput {
    ...
    readonly wasmeditor_hitTest: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
