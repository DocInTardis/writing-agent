...
from writing_agent.web.domains.export_structure_reference_domain import (
    _figure_numbering_is_sequential,
    _gbt7714_reference_violations,
    _normalize_reference_section_for_gbt7714,
    _reference_numbering_is_sequential,
    _reference_unique_count,
    _table_numbering_is_sequential,
